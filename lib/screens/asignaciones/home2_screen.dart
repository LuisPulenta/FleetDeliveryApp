...
class Home2Screen extends StatefulWidget {
  ...
  const Home2Screen({super.key, required this.user, required this.webSesion});
      ...
      child: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xffffffff), Color(0xff88a3be)],
          ),
        ),
        child: ListView(
          children: <Widget>[
            ...
            ListTile(
              leading: const Icon(Icons.router, color: Color(0xff0e4888)),
              title: const Text(
                'Asignaciones',
            ...
            const Divider(color: Color(0xff0e4888), height: 1),
            ListTile(
              leading: const Icon(Icons.map, color: Color(0xff0e4888)),
              title: const Text(
                'Asignaciones radio 20 km (mapa)',
                style: TextStyle(fontSize: 15, color: Color(0xff0e4888)),
              ),
              tileColor: const Color(0xff0e4888),
              onTap: () {
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        EnvioComprobantesScreen(user: widget.user),
                  ),
                );
              },
            ),
            const Divider(color: Color(0xff0e4888), height: 1),
            ListTile(
              leading: const Icon(Icons.equalizer, color: Color(0xff0e4888)),
              title: const Text(
                'Estadísticas',
                style: TextStyle(fontSize: 15, color: Color(0xff0e4888)),
              ),
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Grafico01Screen(user: widget.user),
                  ),
                );
              },
            ),
            const Divider(color: Color(0xff0e4888), height: 1),
            ListTile(
              leading: const Icon(Icons.description, color: Color(0xff0e4888)),
              title: const Text(
                'Mis Datos',
                style: TextStyle(fontSize: 15, color: Color(0xff0e4888)),
              ),
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => MisDatosScreen(user: widget.user),
                  ),
                );
              },
            ),
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        EquiposParaDevolverScreen(user: widget.user),
                  ),
                );
              },
            ),
            const Divider(color: Color(0xff0e4888), height: 1),
            ListTile(
              leading: const Icon(Icons.contact_page, color: Color(0xff0e4888)),
              title: const Text(
                'Contacto',
                style: TextStyle(fontSize: 15, color: Color(0xff0e4888)),
              ),
