...
class Asign {
  ...
  Asign({
    ...
    required this.imagePhotoChanged,
  ...
  Asign.fromJson(Map<String, dynamic> json) {
    ...
    imagePhotoChanged = json['imagePhotoChanged'] ?? false;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['imagePhotoChanged'] = imagePhotoChanged;
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'imagePhotoChanged': imagePhotoChanged,
