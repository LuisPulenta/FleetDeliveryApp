...
class ApiHelper {
  ...
  static Future<Response> getMisDatos(String id) async {
    ...
    SubContratistasUsrVehiculo subContratistasUsrVehiculo =
        SubContratistasUsrVehiculo(
          ...
          linkAntecedentes: '',
          linkVtvFullPath: '',
          linkObleaGasFullPath: '',
          linkPolizaSeguroFullPath: '',
          linkCedulaFullPath: '',
          linkAntecedentesFullPath: '',
        );

    if (body != "") {
      var decodedJson = jsonDecode(body);
      subContratistasUsrVehiculo = SubContratistasUsrVehiculo.fromMap(
        decodedJson,
      );
    }
  ...
  static Future<Response> getNroRegistroMax() async {
    var url = Uri.parse(
      '${Constants.apiUrl}/api/Seguimientos/GetNroRegistroMax',
    );
    var response = await http.get(
      url,
      headers: {
  ...
  //---------------------------------------------------------------------------
  static Future<Response> getAsignacionesEjb(int codigo) async {
    var url = Uri.parse(
      '${Constants.apiUrl}/api/Usuarios/getAsignacionesEjb/$codigo',
    );
    var response = await http.post(
      url,
      headers: {
  ...
  static Future<Response> getAutonumericos(Map<String, dynamic> request) async {
    var url = Uri.parse(
      '${Constants.apiUrl}/api/AsignacionesOTs/GetAutonumericos',
    );
    var response = await http.post(
      url,
      headers: {
  ...
  static Future<Response> getEnvioByIdEnvio(String codigo) async {
    var url = Uri.parse(
      '${Constants.apiUrl}/api/Envios/GetEnvioByIdEnvio/$codigo',
    );
    var response = await http.get(
      url,
      headers: {
  ...
  //---------------------------------------------------------------------------
  static Future<Response> getAsigHistNroRegistroMax() async {
    var url = Uri.parse(
      '${Constants.apiUrl}/api/AsignacionesOTs/GetNroRegistroMax',
    );
    var response = await http.get(
      url,
      headers: {
